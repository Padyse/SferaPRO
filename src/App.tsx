  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative h-8 w-8">
        <div className="absolute inset-0 rounded-full bg-gradient-to-br from-fuchsia-400 to-cyan-300 opacity-80 blur-[10px]" />
        <div className="absolute inset-[2px] rounded-full bg-gradient-to-br from-fuchsia-400 to-cyan-300" />
      ...
      <div className="text-xs font-semibold tracking-[0.28em] text-white/80">SFERA</div>
    </div>
  )
}
